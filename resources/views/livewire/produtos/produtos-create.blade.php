<div class="min-h-screen bg-purple-50 p-6 font-sans">
    <h2 class="text-purple-700 font-bold text-xl mb-4">Cadastrar Produto</h2>
    ...
    <div class="bg-white p-6 rounded shadow mb-6">
        ...
        <div class="mt-4 flex space-x-2">
            <button wire:click="store" class="bg-purple-600 hover:bg-purple-800 text-white py-2 px-4 rounded shadow">Cadastrar</button>
